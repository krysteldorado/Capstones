...
class UserDesignationCollegeLivewire extends Component
{
    ...
    public function mount(Designation $designation)
    {
        ...
        abort_if($designation->access!='college', 404);
    ...
    {
        return view('livewire.user.page.user-designation-college-livewire', [
