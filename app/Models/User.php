...
class User extends Authenticatable
{
    ...
    {
        return $this->hasMany(Alumnus::class, 'user_id', 'id');
    }

    public function alumni_registers()
    {
        return $this->hasMany(RegisteredAlumni::class, 'user_id', 'id');
    }
